...
param_groups(1).stop_criterion = "fixed_steps50";
...
param_groups(3).stop_criterion = "fixed_steps50";
...
param_groups(4).stop_criterion = "fixed_steps50";
...
param_groups(5).stop_criterion = "fixed_steps50";
...
param_groups(6).stop_criterion = "fixed_steps50";
...
param_groups(7).stop_criterion = "fixed_steps50";
...
param_groups(8).stop_criterion = "fixed_steps50";
