% Modified from: https://www.mathworks.com/matlabcentral/answers/3314-hash-function-for-matlab-struct 
%   Lucas Wilkinson - Added string support
...
elseif isstring(Data)
   if not(Data == "")
       Engine.update(java.lang.String(Data).getBytes());
       H = bitxor(H, double(typecast(Engine.digest, 'uint8')));
   else
       % do nothing
   end
